      ...
      <div>
        <div style={styles.toolbar}>
          ...
          <Dropdown style = {{display: "inline-block"}}>
            <Dropdown.Toggle id="dropdown-basic" size = "sm"  variant = "secondary"> Font Size </Dropdown.Toggle>
            <Dropdown.Menu>
              {fontStyles.map(style => (
                ...
                >
                  {style}
					...
					<Dropdown style = {{display: "inline-block"}}>
            <Dropdown.Toggle id="dropdown-basic" size = "sm" variant = "secondary"> Font Color </Dropdown.Toggle>
            <Dropdown.Menu>
